...
export default function Login() {
  ...
  return (
    <div className="min-h-[100vh] overflow-hidden  bg-[#0D1117] flex items-center justify-center p-4">
      <div className=" absolute top-0 right-0 w-96 h-96 bg-[#1D2432] rounded-full filter blur-3xl opacity-20 -translate-y-1/2 translate-x-1/2" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#3B82F6] rounded-full filter blur-3xl opacity-10 translate-y-1/2 -translate-x-1/2" />
